...
//34 + 56 + 230
//: Notice that because comments are ignored, no result appears in the results bar for that line of code.
200 + 34 + 45
1 + 1
//: - experiment:\
...
//:Edit some of the existing expressions and a few of your own.\
